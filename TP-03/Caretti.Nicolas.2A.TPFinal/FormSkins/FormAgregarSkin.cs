...
namespace FormSkins
{
    public partial class FormAgregarSkin : Form
    {
        ...
        List<Arma> auxArmas = ClaseSerializadora<List<Arma>>.Leer("lista");
        ...
        private void btnConfirmarSkin_Click(object sender, EventArgs e)
        {
            ...
            if (rdioArmaDeFuego.Checked is true)
            {
                ...
                if (camposOk)
                {
                    ...
                    {
                        ArmaDeFuego ar = new ArmaDeFuego((Arma.ETipoArma)cmbTipoArma.SelectedItem, (Arma.ECalidadArma)cmbCalidadArma.SelectedItem, txtNombreSkin.Text, floatSkin, precio);
                        listaArmas.Add(ar);
                        todoOk = true;
                    }
                }
