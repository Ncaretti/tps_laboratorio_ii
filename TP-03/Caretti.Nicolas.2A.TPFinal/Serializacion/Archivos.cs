...
namespace Serializacion
{
    public class Archivos : IDato
    {
        ...
        /// <summary>
        /// Metodo sin utilidad para aplicar el concepto de Interfaces.
        /// </summary>
        /// <param name="dato"></param>
        public void AplicarInterface(string dato)
        {
            dato = "No encuentro una aplicacion util y rapida de interfaces asi que hago esto.";
        }
    }
}
